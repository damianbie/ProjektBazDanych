 ...
 */
final class Version20220204193248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repair_order ADD additional_info VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repair_order DROP additional_info, CHANGE client_code client_code VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
