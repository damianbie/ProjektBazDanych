 ...
 */
final class Version20220204132224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repair_order ADD end_date DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repair_order DROP end_date, CHANGE client_code client_code VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
