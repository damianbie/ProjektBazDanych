...
class AddEditUserType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('roles', ChoiceType::class, ['label' => 'Uprawnienia', 'multiple' => true, 'choices' => Roles::getRoles()] )
            ->add('active', CheckboxType::class, [ 'label' => 'Konto aktywne(pozwala na logowanie do serwisu)', 'required' => false ])
            ->add('worker', EntityType::class, ['label' => 'Profil pracownika',
                'required' => true, 'class' => Worker::class, 'query_builder' => function (WorkerRepository  $er) {
